<div class="navbar bg-base-100 border-b border-base-300 px-4 h-16">
    ...
    <div class="navbar-end gap-2">
        ...
        <div class="dropdown dropdown-end">
            ...
            <div tabindex="0" class="card card-compact dropdown-content z-[1] mt-3 w-80 bg-base-100 shadow-xl border border-base-200">
                <div class="card-body">
                    <h3 class="font-bold text-base">{{ __('Notifications') }}</h3>
                    <div class="divider my-1"></div>
                    <p class="text-xs text-base-content/60 text-center py-4">{{ __('No new notifications') }}</p>
                </div>
            </div>
        </div>
